...
<div className="mt-5">
    ...
    <div className="my-3">
        <label  className="form-label d-flex text-start"><i class="fas fa-phone-square mx-2" style={{color: "#B197FC",fontSize : 24}}></i>Phone</label>
        <input type="text" className="form-control"  placeholder="+34-666-66-66-66" />
    </div>
    <div className="my-3">
        <label className="form-label d-flex text-start"><i class="fas fa-map-marker-alt mx-2" style={{color: "#B197FC", fontSize : 24}}></i>Address</label>
